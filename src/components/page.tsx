...
const ChatPage = ({ socket, username, roomId }: any) => {
  ...
  console.log(`currently it's ${receivedMsgRef.current} saved`);
  ...
  useEffect(() => {
    socket.on("receive_msg", (data: IMsgDataTypes) => {
      console.log(`this message "${data.msg.toString()}" is from ${data.user}`);
      receivedMsgRef.current = data.msg.toString();
